...
class PactProviderTest extends TestCase
{
    public function testVerifyAllContracts()
    {
        $config = new VerifierConfig();
        $config
            ->setProviderName('Customer Api') // Providers name to fetch.
